(()=>{ var __RUSHSTACK_CURRENT_SCRIPT__ = document.currentScript; define("a8f9f6a5-5d6a-4b0c-8e7f-3d8b8b75f3a1_1.0.0", ["react","react-dom","@microsoft/sp-core-library","@microsoft/sp-webpart-base"], (__WEBPACK_EXTERNAL_MODULE__2650__, __WEBPACK_EXTERNAL_MODULE__2729__, __WEBPACK_EXTERNAL_MODULE__3878__, __WEBPACK_EXTERNAL_MODULE__3134__) => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ 484:
/*!***************************************************************!*\
  !*** ./lib/webparts/koalaHubPortal/KoalaHubPortal.module.css ***!
  \***************************************************************/
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".portal_03c92683{background:#f5f7fa;color:#1c2430;font-family:Segoe UI,Arial,sans-serif;min-height:760px}.header_03c92683{align-items:center;background:#fff;border-bottom:1px solid #e4e7ec;display:flex;gap:18px;height:76px;padding:0 28px}.headerIcon_03c92683,.iconButton_03c92683,.menuButton_03c92683{background:0 0;border:0;color:#1c2430;cursor:pointer;font-size:20px}.menuButton_03c92683{display:none}.logo_03c92683{height:auto;width:112px}.headerTitle_03c92683{border-left:1px solid #e4e7ec;display:flex;flex-direction:column;padding-left:18px}.headerTitle_03c92683 strong{font-size:20px;letter-spacing:-.4px}.headerTitle_03c92683 span,.profile_03c92683 small{color:#667085;font-size:11px}.headerTools_03c92683{align-items:center;display:flex;gap:18px;margin-left:auto}.globalSearch_03c92683,.searchBox_03c92683{align-items:center;background:#fff;border:1px solid #e4e7ec;border-radius:5px;color:#667085;display:flex;gap:8px;padding:7px 10px}.globalSearch_03c92683 input,.searchBox_03c92683 input{border:0;font-size:13px;outline:0;width:170px}.profile_03c92683{align-items:center;display:flex;gap:9px}.profile_03c92683 small,.profile_03c92683 strong{display:block}.profile_03c92683 strong{font-size:13px}.avatar_03c92683{background:#5b2a86;border-radius:50%;color:#fff;display:grid;font-size:11px;font-weight:700;height:34px;place-items:center;width:34px}.body_03c92683{display:flex;min-height:650px}.sidebar_03c92683{background:#202a38;display:flex;flex:0 0 226px;flex-direction:column;padding:25px 13px 18px;width:226px}.sidebar_03c92683 .ms-Nav-link{border-radius:5px;color:#d7dee8;margin-bottom:5px}.sidebar_03c92683 .ms-Nav-link:hover,.sidebar_03c92683 .ms-Nav-link[aria-current=page]{background:#d71920;color:#fff}.sidebar_03c92683 .ms-Nav-link[aria-current=page]{font-weight:600}.sidebar_03c92683 .ms-Nav-chevron{color:#fff}.sidebarBottom_03c92683{color:#9da9b8;font-size:11px;margin-top:auto}.sidebarBottom_03c92683 small{display:block;margin-top:22px}.helpCard_03c92683{border:1px solid #425064;border-radius:6px;display:grid;grid-template-columns:28px 1fr;padding:14px}.helpCard_03c92683 span{color:#aeb9c6;font-size:11px;grid-column:2;margin-top:3px}.main_03c92683{flex:1;overflow:hidden;padding:25px 34px 40px}.breadcrumb_03c92683{align-items:center;color:#667085;display:flex;font-size:12px;gap:7px;margin-bottom:18px}.breadcrumb_03c92683 svg{font-size:10px}.pageHeading_03c92683{align-items:flex-start;display:flex;justify-content:space-between;margin-bottom:22px}.pageHeading_03c92683 h1{font-size:30px;letter-spacing:-.8px;margin:0 0 5px}.pageHeading_03c92683 p{color:#667085;font-size:14px;margin:0}.lastUpdated_03c92683{align-items:center;color:#667085;display:flex;font-size:12px;gap:6px}.hero_03c92683{align-items:center;background:linear-gradient(115deg,#202a38,#202a38 52%,#412061);border-radius:9px;color:#fff;display:flex;justify-content:space-between;min-height:210px;overflow:hidden;padding:35px 42px}.eyebrow_03c92683{color:#d71920;font-size:11px;font-weight:700;letter-spacing:1.2px;margin:0 0 9px}.hero_03c92683 .eyebrow_03c92683{color:#f7b0b3}.hero_03c92683 h2{font-size:29px;margin:0 0 8px}.hero_03c92683 p:not(.eyebrow_03c92683){color:#d7dee8;line-height:1.5;margin:0;max-width:520px}.heroActions_03c92683{display:flex;gap:12px;margin-top:24px}.filterButton_03c92683,.primaryButton_03c92683,.secondaryButton_03c92683{align-items:center;border:0;border-radius:4px;cursor:pointer;display:inline-flex;font-weight:600;gap:9px;padding:10px 15px}.primaryButton_03c92683{background:#d71920;color:#fff}.filterButton_03c92683,.secondaryButton_03c92683{background:#fff;border:1px solid #e4e7ec;color:#1c2430}.heroMark_03c92683{border:1px solid hsla(0,0%,100%,.25);border-radius:50%;display:grid;height:150px;place-items:center;position:relative;transform:rotate(-12deg);width:190px}.heroMark_03c92683 span{font-size:29px;font-weight:700;letter-spacing:5px;transform:rotate(12deg)}.heroMark_03c92683 i{border:7px solid #d71920;border-radius:50%;height:31px;position:absolute;right:22px;top:17px;width:31px}.metricGrid_03c92683{display:grid;gap:14px;grid-template-columns:repeat(4,1fr);margin:18px 0}.metricCard_03c92683,.panel_03c92683{background:#fff;border:1px solid #e4e7ec;border-radius:8px;box-shadow:0 2px 8px rgba(16,24,40,.04)}.metricCard_03c92683{align-items:center;display:flex;gap:13px;padding:17px}.metricIcon_03c92683{border-radius:7px;display:grid;height:38px;place-items:center;width:38px}.metricBlue_03c92683{background:#eaf3ff;color:#1459a6}.metricPurple_03c92683{background:#f1eafd;color:#5b2a86}.metricRed_03c92683{background:#ffebec;color:#d71920}.metricAmber_03c92683{background:#fff4dd;color:#a76500}.metricDetail_03c92683,.metricLabel_03c92683{color:#667085;font-size:11px;margin:0}.metricValue_03c92683{display:block;font-size:24px;margin:2px 0}.metricDetail_03c92683{font-size:10px}.contentGrid_03c92683{display:grid;gap:18px;grid-template-columns:1.35fr .65fr}.panel_03c92683{padding:23px}.panelHeader_03c92683{align-items:flex-start;display:flex;justify-content:space-between;margin-bottom:21px}.panelHeader_03c92683 h2{font-size:20px;margin:0}.panelHeader_03c92683 .eyebrow_03c92683{margin-bottom:5px}.actionList_03c92683{border-top:1px solid #e4e7ec}.actionItem_03c92683{align-items:center;border-bottom:1px solid #e4e7ec;display:flex;gap:13px;padding:16px 0}.actionItem_03c92683>div{flex:1}.actionItem_03c92683 strong{font-size:13px}.actionItem_03c92683 p{color:#667085;font-size:11px;margin:4px 0 0}.actionItem_03c92683>svg{color:#667085}.actionIcon_03c92683{border-radius:50%;display:grid;height:34px;place-items:center;width:34px}.actionRed_03c92683{background:#ffebec;color:#d71920}.actionPurple_03c92683{background:#f1eafd;color:#5b2a86}.actionGreen_03c92683{background:#e8f7ef;color:#18864b}.scorePanel_03c92683{background:linear-gradient(160deg,#fff 55%,#faf5ff)}.largeShield_03c92683{color:#5b2a86;font-size:30px}.scoreRow_03c92683{align-items:baseline;display:flex;gap:8px}.scoreRow_03c92683 strong{color:#5b2a86;font-size:57px;letter-spacing:-3px}.scoreRow_03c92683 span{color:#667085;font-size:13px}.scoreRow_03c92683 b{color:#5b2a86}.progressTrack_03c92683{background:#eee7f5;border-radius:8px;height:8px;margin:17px 0 11px;overflow:hidden}.progressTrack_03c92683 span{background:linear-gradient(90deg,#d71920,#5b2a86);display:block;height:100%}.muted_03c92683{color:#667085;font-size:12px;line-height:1.5}.textButton_03c92683{align-items:center;background:0 0;border:0;color:#5b2a86;cursor:pointer;display:inline-flex;font-weight:600;gap:5px;padding:0}.textButton_03c92683 svg{font-size:11px}.filterBar_03c92683{display:flex;gap:10px;margin-bottom:18px}.searchBox_03c92683{flex:1}.searchBox_03c92683 input{width:100%}.activityGrid_03c92683{display:grid;gap:14px;grid-template-columns:repeat(2,1fr)}.activityCard_03c92683{border:1px solid #e4e7ec;border-radius:6px;padding:17px}.activityTopline_03c92683{display:flex;justify-content:space-between}.categoryTag_03c92683,.statusTag_03c92683{border-radius:3px;font-size:10px;font-weight:600;padding:4px 7px}.categoryTag_03c92683{background:#f1eafd;color:#5b2a86}.statusCompleted_03c92683{background:#e8f7ef;color:#147d42}.statusProgress_03c92683{background:#fff4dd;color:#995900}.statusRisk_03c92683{background:#ffebec;color:#d71920}.activityCard_03c92683 h3{font-size:16px;margin:17px 0 8px}.activityOwner_03c92683{color:#667085;font-size:12px}.activityFooter_03c92683{align-items:center;color:#667085;display:flex;font-size:11px;justify-content:space-between;margin-top:23px}.emptyState_03c92683{color:#667085;padding:35px;text-align:center}.insightGrid_03c92683{display:grid;gap:15px;grid-template-columns:repeat(2,1fr)}.insightCard_03c92683{border:1px solid #e4e7ec;border-radius:7px;padding:20px}.insightNumber_03c92683{color:#5b2a86;display:block;font-size:35px;font-weight:700}.insightCard_03c92683 strong{display:block;margin:5px 0}.insightCard_03c92683 p{color:#667085;font-size:12px;line-height:1.5}.callout_03c92683{background:#f8f3fc;border-radius:6px;color:#5b2a86;display:flex;gap:13px;margin-top:18px;padding:17px}.callout_03c92683 p{color:#667085;font-size:12px;line-height:1.5;margin:5px 0 0}.sectionIcon_03c92683{color:#5b2a86;font-size:30px}.footer_03c92683{background:#fff;border-top:1px solid #e4e7ec;color:#667085;display:flex;font-size:11px;justify-content:space-between;padding:14px 34px}.srOnly_03c92683{clip:rect(0,0,0,0);height:1px;overflow:hidden;position:absolute;width:1px}@media (max-width:900px){.header_03c92683{padding:0 16px}.menuButton_03c92683{display:block}.globalSearch_03c92683,.headerTitle_03c92683{display:none}.sidebar_03c92683{flex-basis:190px;width:190px}.main_03c92683{padding:20px}.metricGrid_03c92683{grid-template-columns:repeat(2,1fr)}.contentGrid_03c92683{grid-template-columns:1fr}}@media (max-width:620px){.sidebar_03c92683{display:none}.portalCollapsed_03c92683 .sidebar_03c92683{display:block;height:100%;position:absolute;z-index:3}.hero_03c92683{padding:25px}.heroMark_03c92683{display:none}.activityGrid_03c92683,.insightGrid_03c92683,.metricGrid_03c92683{grid-template-columns:1fr}.pageHeading_03c92683{display:block}.lastUpdated_03c92683{margin-top:12px}.footer_03c92683{flex-wrap:wrap;gap:8px;padding:14px 20px}}\n/*# sourceMappingURL=data:application/json;base64, */", true);
...
/***/ 5685:
/*!*******************************************************!*\
  !*** ./lib/webparts/koalaHubPortal/KoalaHubPortal.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* unused harmony export KoalaHubPortal */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _fluentui_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fluentui/react */ 3257);
/* harmony import */ var _fluentui_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fluentui/react */ 7353);
/* harmony import */ var _assets_koala_logo_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/koala-logo.svg */ 9748);
/* harmony import */ var _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./KoalaHubPortal.module.scss */ 2426);
...
const statusClass = (status) => {
    if (status === 'Completed')
        return _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].statusCompleted;
    if (status === 'At risk')
        return _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].statusRisk;
    return _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].statusProgress;
};
const MetricCard = ({ label, value, detail, tone = _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricBlue }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricCard },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricIcon} ${tone}`, "aria-hidden": "true" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "BarChartVertical" })),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricLabel }, label),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricValue }, value),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricDetail }, detail))));
const ActivityCard = ({ item }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].activityCard },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].activityTopline },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].categoryTag }, item.category),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].statusTag} ${statusClass(item.status)}` }, item.status)),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, item.title),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].activityOwner }, item.owner),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].activityFooter },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, item.due),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].textButton, type: "button" },
            "View details ",
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" })))));
const KoalaHubPortal = ({ description }) => {
    const [activePath, setActivePath] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(getCurrentPath);
    const [navCollapsed, setNavCollapsed] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    ...
    const navigate = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((view) => {
    ...
    const filteredActivities = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => activities.filter(item => item.title.toLowerCase().includes(query.toLowerCase()) || item.category.toLowerCase().includes(query.toLowerCase())), [query]);
    const activeName = activeRoute.name;
    const renderOverview = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].hero },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].eyebrow }, "KOALA HUB / ONE STOP SHOP"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Clarity for every capability."),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Bring resource compliance, capability development, and secure behavior into one focused workspace."),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].heroActions },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].primaryButton, type: "button", onClick: () => navigate('compliance') },
                        "Review compliance ",
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].secondaryButton, type: "button", onClick: () => navigate('reports') }, "Open insights"))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].heroMark, "aria-hidden": "true" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "KOALA"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", null))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricGrid, "aria-label": "Koala Hub summary" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MetricCard, { label: "Resource compliance", value: "92%", detail: "+4% from last month" }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MetricCard, { label: "Capability completion", value: "78%", detail: "14 activities in progress", tone: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricPurple }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MetricCard, { label: "Secure behavior", value: "925", detail: "Top notch / 1,000", tone: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricRed }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MetricCard, { label: "Actions due", value: "6", detail: "2 need attention", tone: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].metricAmber })),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].contentGrid },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panel },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panelHeader },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].eyebrow }, "YOUR WORKSPACE"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Recommended next actions")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].iconButton, type: "button", "aria-label": "Download action list" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Download" }))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionList },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionItem },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionIcon} ${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionRed}` },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Shield" })),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Complete secure collaboration practices"),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Due 30 September \u00B7 Information Security")),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionItem },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionIcon} ${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionPurple}` },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "LearningTools" })),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Continue your capability pathway"),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "2 learning activities ready to start")),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionItem },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionIcon} ${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].actionGreen}` },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "StatusCircleCheckmark" })),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Review your compliance summary"),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "All current obligations in one view")),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" })))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panel} ${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].scorePanel}` },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panelHeader },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].eyebrow }, "SECURE BEHAVIOR"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Your score")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Shield", className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].largeShield })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].scoreRow },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "925"),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null,
                        "/ 1,000",
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("b", null, "Top notch"))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].progressTrack },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: { width: '92.5%' } })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].muted }, "Strong secure behavior. Keep building habits that protect our people and clients."),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].textButton, type: "button", onClick: () => navigate('security') },
                    "View security insights ",
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" }))))));
    const renderActivityView = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panel },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panelHeader },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].eyebrow }, "RESOURCE COMPLIANCE"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Activity register")),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].primaryButton, type: "button" }, "Add activity")),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].filterBar },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].searchBox },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Search" }),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { "aria-label": "Search activities", placeholder: "Search activities or categories", value: query, onChange: event => setQuery(event.target.value) })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].filterButton, type: "button" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Filter" }),
                " Filters")),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].activityGrid }, filteredActivities.map(item => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ActivityCard, { item: item, key: item.id }))),
        filteredActivities.length === 0 && react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].emptyState }, "No activities match your search.")));
    const renderSimpleView = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panel },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].panelHeader },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].eyebrow }, activeName.toUpperCase()),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, activeName)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: activeView === 'security' ? 'Shield' : 'PieSingleChart', className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].sectionIcon })),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].insightGrid },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].insightCard },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].insightNumber }, activeView === 'security' ? '925' : activeView === 'resources' ? '59' : activeView === 'admin' ? '7' : '14'),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, activeView === 'security' ? 'Secure behavior score' : activeView === 'resources' ? 'Active resources' : activeView === 'admin' ? 'Configured areas' : 'Active pathways'),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, activeView === 'security' ? 'Top notch performance across current measures.' : activeView === 'resources' ? 'People, teams, and ownership records available to you.' : activeView === 'admin' ? 'Governed configuration areas for portal owners.' : 'Learning journeys available for your role and team.')),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].insightCard },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].insightNumber }, activeView === 'security' ? '3' : activeView === 'resources' ? '10' : activeView === 'admin' ? '3' : '78%'),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, activeView === 'security' ? 'Recommended actions' : activeView === 'resources' ? 'Teams represented' : activeView === 'admin' ? 'Integration boundaries' : 'Overall completion'),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, activeView === 'security' ? 'Small actions that can strengthen your score.' : activeView === 'resources' ? 'Use the resource view to understand coverage and ownership.' : activeView === 'admin' ? 'Connect approved services without changing the experience.' : 'Progress is measured across required capability areas.'))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].callout },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "CompassNW" }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Designed for the next step"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Connect this view to the approved SharePoint, Power BI, and secure behavior services when the integration contracts are ready.")))));
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: `${_KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].portal} ${navCollapsed ? _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].portalCollapsed : ''}` },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].header },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].menuButton, type: "button", "aria-label": "Toggle navigation", onClick: () => setNavCollapsed(!navCollapsed) },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "CollapseMenu" })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].logo, src: _assets_koala_logo_svg__WEBPACK_IMPORTED_MODULE_1__, alt: "Koala Hub" }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].headerTitle },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Koala Hub"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Resource, capability & security portal")),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].headerTools },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].globalSearch },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Search" }),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { "aria-label": "Global search", placeholder: "Search Koala Hub" })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].headerIcon, type: "button", "aria-label": "Notifications" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Ringer" })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].profile },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].avatar }, "MR"),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Marlon Roxas"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("small", null, "Portal member"))))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].body },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("aside", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].sidebar, "aria-label": "Primary navigation" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_4__.Nav, { groups: [{ links: navItems.map(item => ({ key: item.key, name: item.name, icon: item.icon, url: getRoutePath(item.key), onClick: (event) => { event?.preventDefault(); navigate(item.key); } })) }], selectedKey: activeView }),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].sidebarBottom },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].helpCard },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Help" }),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Need help?"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Visit the Koala guide")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("small", null, "iDS Hub \u00B7 Koala experience"))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].main },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].breadcrumb },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Koala Hub"),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "ChevronRight" }),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, activeName)),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].pageHeading },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, activeName),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, description || 'A single workspace for the work that keeps our teams ready.'),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].srOnly }, "iDS Hub Portal"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].srOnly }, "Welcome to the iDS Hub")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].lastUpdated },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: "Refresh" }),
                        " Updated today")),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("footer", { className: _KoalaHubPortal_module_scss__WEBPACK_IMPORTED_MODULE_2__["default"].footer },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Koala Hub"),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Built for clearer, safer delivery"),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Powered by iDS Hub"))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (KoalaHubPortal);
...
/***/ 2426:
/*!*******************************************************************!*\
  !*** ./lib/webparts/koalaHubPortal/KoalaHubPortal.module.scss.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* tslint:disable */
__webpack_require__(/*! ./KoalaHubPortal.module.css */ 484);
const styles = {
...
function portalContainsElement(target, parent, doc) {
    var _a;
    var elementMatch = (0,_findElementRecursive__WEBPACK_IMPORTED_MODULE_0__.findElementRecursive)(target, function (testElement) { var _a; return parent === testElement || !!((_a = testElement.hasAttribute) === null || _a === void 0 ? void 0 : _a.call(testElement, _setPortalAttribute__WEBPACK_IMPORTED_MODULE_1__.DATA_PORTAL_ATTRIBUTE)); }, doc);
    return elementMatch !== null && !!((_a = elementMatch.hasAttribute) === null || _a === void 0 ? void 0 : _a.call(elementMatch, _setPortalAttribute__WEBPACK_IMPORTED_MODULE_1__.DATA_PORTAL_ATTRIBUTE));
}
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ 7582);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
 ...
 */
function useAsync() {
    var asyncRef = react__WEBPACK_IMPORTED_MODULE_0__.useRef(undefined);
    if (!asyncRef.current) {
...
function useTarget(target, hostElement) {
    var _a, _b, _c;
    var previousTargetProp = react__WEBPACK_IMPORTED_MODULE_0__.useRef(undefined);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 7582);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony export */ });
/* unused harmony exports useDocument, WindowProvider */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _BaseButton_styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../BaseButton.styles */ 6823);
...
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../Utilities */ 9538);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../Utilities */ 8288);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../Utilities */ 8345);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../Utilities */ 3568);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../Utilities */ 2402);
...
/* harmony import */ var _Popup__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../Popup */ 8904);
...
/* harmony import */ var _fluentui_react_hooks__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @fluentui/react-hooks */ 9477);
/* harmony import */ var _fluentui_react_hooks__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @fluentui/react-hooks */ 355);
/* harmony import */ var _fluentui_react_hooks__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @fluentui/react-hooks */ 1898);
var _a;
...
var ContextualMenuBase = react__WEBPACK_IMPORTED_MODULE_0__.memo(react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    ...
    var adjustedFocusZoneProps = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({ direction: _FocusZone__WEBPACK_IMPORTED_MODULE_14__.FocusZoneDirection.vertical, handleTabKey: _FocusZone__WEBPACK_IMPORTED_MODULE_14__.FocusZoneTabbableElements.all, isCircularNavigation: true }, focusZoneProps), { className: (0,_Utilities__WEBPACK_IMPORTED_MODULE_32__.css)(classNames.root, (_a = props.focusZoneProps) === null || _a === void 0 ? void 0 : _a.className) });
    ...
    return (0,_Styling__WEBPACK_IMPORTED_MODULE_0__.mergeStyleSets)({
            ...
            !disabled &&
                !expanded && [
                {
                    selectors: (_a = {
                        ...
                        _a[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus, .").concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus:hover")] = styles.rootFocused,
                        _a[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:hover")] = { background: 'inherit;' },
                        _a),
                },
            ],
            className,
            ...
            !(disabled || primaryDisabled) &&
                !checked && [
                {
                    selectors: (_b = {
                        ...
                        _b[':active'] = styles.rootPressed,
                        _b[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus, .").concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus:hover")] = styles.rootFocused,
                        _b[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:hover")] = { background: 'inherit;' },
                        _b),
                },
            ],
        ],
            ...
            !disabled &&
                !expanded && [
                {
                    selectors: (_c = {
                        ...
                        _c[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus, .").concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus:hover")] = styles.rootFocused,
                        _c[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:hover")] = { background: 'inherit;' },
                        _c),
                },
            ],
        ],
        ...
        splitContainer: [
            ...
            !disabled &&
                ...
                {
                    selectors: (_d = {},
                        _d[".".concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus, .").concat(_Utilities__WEBPACK_IMPORTED_MODULE_4__.IsFocusVisibleClassName, " &:focus:hover")] = styles.rootFocused,
                        _d),
                },
            ],
        ],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! tslib */ 7582);
/* harmony import */ var _fluentui_react_portal_compat_context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fluentui/react-portal-compat-context */ 5814);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
var LayerBase = react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(function (props, ref) {
    ...
    var getHost = function (doc) {
        ...
        if (hostId) {
            ...
            if (!host) {
                host = (0,_Layer_notification__WEBPACK_IMPORTED_MODULE_7__.createDefaultLayerHost)(doc);
            }
            return host;
        }
    };
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../Button */ 7921);
/* harmony import */ var _Nav_styles__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Nav.styles */ 2591);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Utilities */ 4041);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../Utilities */ 9832);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../Utilities */ 8345);
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../Utilities */ 4362);
/* harmony import */ var _FocusZone__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../FocusZone */ 6313);
/* harmony import */ var _FocusZone__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../FocusZone */ 2194);
/* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Icon */ 3257);
/* harmony import */ var _fluentui_utilities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @fluentui/utilities */ 6833);
...
var NavBase = /** @class */ (function (_super) {
    ...
    NavBase.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_FocusZone__WEBPACK_IMPORTED_MODULE_5__.FocusZone, (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({ direction: _FocusZone__WEBPACK_IMPORTED_MODULE_6__.FocusZoneDirection.vertical, componentRef: this._focusZone }, this.props.focusZoneProps),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("nav", { role: role, className: classNames.root, "aria-label": this.props.ariaLabel }, groupElements)));
    };
...
/* harmony export */ });
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Utilities */ 9710);
/* harmony import */ var _Nav_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Nav.base */ 9940);
/* harmony import */ var _Nav_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Nav.styles */ 2591);
...
/* harmony import */ var _Utilities__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Utilities */ 5599);
...
/* harmony export */   HighContrastSelector: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_6__.HighContrastSelector),
/* harmony export */   IconFontSizes: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_1__.IconFontSizes),
/* harmony export */   ScreenWidthMaxMedium: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_6__.ScreenWidthMaxMedium),
/* harmony export */   ZIndexes: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_7__.ZIndexes),
/* harmony export */   concatStyleSets: () => (/* reexport safe */ _MergeStyles__WEBPACK_IMPORTED_MODULE_9__.concatStyleSets),
/* harmony export */   concatStyleSetsWithProps: () => (/* reexport safe */ _MergeStyles__WEBPACK_IMPORTED_MODULE_10__.concatStyleSetsWithProps),
/* harmony export */   focusClear: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_4__.focusClear),
/* harmony export */   getFocusStyle: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_4__.getFocusStyle),
/* harmony export */   getGlobalClassNames: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_3__.getGlobalClassNames),
/* harmony export */   getHighContrastNoAdjustStyle: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_6__.getHighContrastNoAdjustStyle),
/* harmony export */   getIcon: () => (/* reexport safe */ _utilities_index__WEBPACK_IMPORTED_MODULE_8__.getIcon),
/* harmony export */   getScreenSelector: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_6__.getScreenSelector),
/* harmony export */   getTheme: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_5__.getTheme),
/* harmony export */   hiddenContentStyle: () => (/* reexport safe */ _styles_index__WEBPACK_IMPORTED_MODULE_2__.hiddenContentStyle),
/* harmony export */   mergeStyleSets: () => (/* reexport safe */ _MergeStyles__WEBPACK_IMPORTED_MODULE_11__.mergeStyleSets),
/* harmony export */   mergeStyles: () => (/* reexport safe */ _MergeStyles__WEBPACK_IMPORTED_MODULE_12__.mergeStyles)
/* harmony export */ });
/* harmony import */ var _classNames_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classNames/index */ 6618);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/index */ 2936);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles/index */ 3610);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./styles/index */ 1967);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./styles/index */ 6614);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles/theme */ 5587);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./styles/index */ 8125);
/* harmony import */ var _styles_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./styles/index */ 8476);
/* harmony import */ var _utilities_index__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utilities/index */ 9497);
/* harmony import */ var _MergeStyles__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./MergeStyles */ 1371);
/* harmony import */ var _MergeStyles__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./MergeStyles */ 1246);
/* harmony import */ var _MergeStyles__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./MergeStyles */ 8409);
/* harmony import */ var _MergeStyles__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./MergeStyles */ 8467);
/* harmony import */ var _version__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./version */ 7168);
...
(0,_styles_index__WEBPACK_IMPORTED_MODULE_5__.initializeThemeInCustomizations)();
...
/* harmony export */ });
/* unused harmony exports getFocusOutlineStyle, getInputFocusStyle */
...
/* harmony export */ });
/* unused harmony exports findIndex, find, createArray, toMatrix, removeIndex, replaceElement, flatten */
/**
...
/* harmony import */ var _mergeCustomizations__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mergeCustomizations */ 2033);
                ...
                ComponentWithInjectedProps.prototype.render = function () {
                    ...
                    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_shadowDom_contexts_MergeStylesShadowRootConsumer__WEBPACK_IMPORTED_MODULE_5__.MergeStylesShadowRootConsumer, { stylesheetKey: scope }, function (inShadow) {
                        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_CustomizerContext__WEBPACK_IMPORTED_MODULE_6__.CustomizerContext.Consumer, null, function (context) {
                            ...
                            var win = (_b = _this.context.window) !== null && _b !== void 0 ? _b : (0,_dom_getWindow__WEBPACK_IMPORTED_MODULE_7__.getWindow)();
...
/* harmony export */ });
/* unused harmony exports getFirstTabbable, getLastTabbable, isElementVisible, focusAsync */
...
/* harmony export */ });
/* unused harmony exports DATA_IS_SCROLLABLE_ATTRIBUTE, allowScrollOnElement, allowOverscrollOnElement, disableBodyScroll, enableBodyScroll */
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MergeStylesDefaultContext: () => (/* binding */ MergeStylesDefaultContext)
/* harmony export */ });
/* unused harmony export getNewContext */
...
var MergeStylesDefaultContext = react__WEBPACK_IMPORTED_MODULE_0__.createContext(getNewContext());
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _contexts_MergeStylesDefaultContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../contexts/MergeStylesDefaultContext */ 8581);


var useMergeStylesHooks = function () {
    var ctx = react__WEBPACK_IMPORTED_MODULE_0__.useContext(_contexts_MergeStylesDefaultContext__WEBPACK_IMPORTED_MODULE_1__.MergeStylesDefaultContext);
    return {
...
/* harmony export */ });
/* unused harmony export useHasMergeStylesShadowRootContext */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function styled(Component, baseStyles, getProps, customizable, pure) {
    ...
    var Wrapped = react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(function (props, forwardedRef) {
        var styles = react__WEBPACK_IMPORTED_MODULE_0__.useRef(undefined);
...
/* harmony export */ });
/* unused harmony export useFocusRects */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _dom_getWindow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom/getWindow */ 4362);
...
/***/ 9748:
/*!***********************************************************!*\
  !*** ./lib/webparts/koalaHubPortal/assets/koala-logo.svg ***!
  \***********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "koala-logo_47e9291eb07633cfcdf8.svg";
...
(() => {
/*!**************************************************************!*\
  !*** ./lib/webparts/koalaHubPortal/KoalaHubPortalWebPart.js ***!
  \**************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ KoalaHubPortalWebPart)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom */ 2729);
...
/* harmony import */ var _KoalaHubPortal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./KoalaHubPortal */ 5685);





class KoalaHubPortalWebPart extends _microsoft_sp_webpart_base__WEBPACK_IMPORTED_MODULE_3__.BaseClientSideWebPart {
    render() {
        const element = react__WEBPACK_IMPORTED_MODULE_0__.createElement(_KoalaHubPortal__WEBPACK_IMPORTED_MODULE_4__["default"], {
                    ...
                    groups: [
                        {
                            ...
                            groupFields: [
                                (0,_microsoft_sp_webpart_base__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('description', { label: 'Portal description' }),
                            ],
                        },
                    ],
                },
...
//# sourceMappingURL=koala-hub-portal.js.map